...
export class Dictionary {
    ...
    system_feature_bytes(start: number, count: number): Uint8Array;
    system_feature_bytes_matching(start: number, count: number, pos: string, pos1: string): Uint8Array;
    system_feature_count(): number;
    system_features(start: number, count: number): any;
    system_has_surface(surface: string): boolean;
    system_surface_feature_bytes(surface: string): Uint8Array;
    system_surface_features(surface: string): any;
    system_surface_id(surface: string): number | undefined;
    system_surface_reading_bytes_matching(start: number, count: number, pos: string, pos1: string): Uint8Array;
}
...
export interface InitOutput {
    ...
    readonly dictionary_system_feature_bytes: (a: number, b: number, c: number) => [number, number, number, number];
    readonly dictionary_system_feature_bytes_matching: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => [number, number, number, number];
    readonly dictionary_system_feature_count: (a: number) => [number, number, number];
    readonly dictionary_system_features: (a: number, b: number, c: number) => [number, number, number];
    readonly dictionary_system_has_surface: (a: number, b: number, c: number) => [number, number, number];
    readonly dictionary_system_surface_feature_bytes: (a: number, b: number, c: number) => [number, number, number, number];
    readonly dictionary_system_surface_features: (a: number, b: number, c: number) => [number, number, number];
    readonly dictionary_system_surface_id: (a: number, b: number, c: number) => [number, number, number];
    readonly dictionary_system_surface_reading_bytes_matching: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => [number, number, number, number];
